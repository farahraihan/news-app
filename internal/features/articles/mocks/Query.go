...
func (_m *Query) DeleteArticle(id uint) error {
	ret := _m.Called(id)
...
func (_m *Query) GetAllArticles() ([]articles.Article, error) {
	ret := _m.Called()
...
func (_m *Query) GetArticleByID(id uint) (*articles.Article, error) {
	ret := _m.Called(id)
...
func (_m *Query) InsertArticle(newArticle articles.Article) error {
...
func (_m *Query) UpdateArticle(updatedArticle articles.Article) error {
